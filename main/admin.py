...
class CityAdmin(ExportActionMixin, admin.ModelAdmin):
    ...
    search_fields = ['cityName', 'pradesh__pradeshName', 'taluka__talukaName','district__districtName', 'state__stateName', 'pincode']
...
class BhagatDetailAdmin(ExportActionMixin, admin.ModelAdmin):
    list_display = ("name", "districtCode", "receiptNo", "entryDate", "endDate", "subYear", "addressOne","addressTwo", "addressThree", "city", "taluka", "district", "state", 'pradesh', "phoneNum","pincode","dataid","is_active")
    search_fields = ["name", "districtCode", "receiptNo", "entryDate", "endDate", "subYear", "addressOne", "addressTwo", "addressThree","city__cityName", "taluka__talukaName", "district__districtName", "state__stateName", 'pradesh__pradeshName', "phoneNum", "dataid","is_active"]
...
class KaryakartaAdmin(ExportActionMixin, admin.ModelAdmin):
    ...
    search_fields = ["name", "email", "phoneNum", "city__cityName","taluka__talukaName", "district__districtName", "state__stateName"]
